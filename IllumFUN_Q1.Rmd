...
### VST
fit.vst <- lm.rrpp(vst ~ Site + Tissue + Site:Tissue, data = sam, SS.type = "III", iter = 999)
...
fit.rao <- lm.rrpp(d ~ Site + Tissue + Site:Tissue, data = rdf, SS.type = "III", iter = 999)
...
fit.vst <- lm.rrpp(curr.vst ~ Site, data = curr.sam,
               SS.type = "III", iter = 999, print.progress = T)
fit.vst$LM$term.labels  #check order of model terms
